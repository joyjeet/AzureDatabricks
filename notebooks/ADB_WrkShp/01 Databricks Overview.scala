...
// MAGIC 
// MAGIC -   ****The Dataset****
// MAGIC     -   The Dataset is Apache Spark's newest distributed collection and can be considered a combination of DataFrames and RDDs (Resiliant Distributed Dataset). It provides the typed interface that is available in RDDs while providing a lot of conveniences of DataFrames. It will be the core abstraction going forward.
// MAGIC -   ****The DataFrame****
